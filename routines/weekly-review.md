...
- memory/WEEKLY-REVIEW.md (match existing template format exactly)
...
- Starting portfolio (Monday AM equity from TRADE-LOG EOD snapshot)
...
STEP 5 — If a rule needs to change (proven for 2+ weeks or failed badly):
Also update memory/TRADING-STRATEGY.md and call out the change in the review.

STEP 6 — Send ONE Telegram message (always). Keep under 15 lines:
